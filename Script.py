...
<blockquote>🌿ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://telegram.me/bluedragon340'>ᴘꜱʏᴄʜᴏ</a></blockquote></b>"""
...
<code>/font hi how are you</code>"""
    ...
    PREMIUM_TEXT = """<b>👋 ʜᴇʏ {username},</b>

<blockquote>🎖️ᴀᴠᴀɪʟᴀʙʟᴇ ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴꜱ :</blockquote>

1️⃣ **1 ᴡᴇᴇᴋ** – ₹19 (₹2.71/day)  
2️⃣ **1 ᴍᴏɴᴛʜ** – ₹49 (₹1.63/day)  
3️⃣ **3 ᴍᴏɴᴛʜs** – ₹119 (₹1.32/day, Save ₹28!)  
4️⃣ **6 ᴍᴏɴᴛʜs** – ₹199 (₹1.10/day, Save ₹49!)  
5️⃣ **12 ᴍᴏɴᴛʜs** – ₹349 (₹0.96/day, Best Value! Save ₹49!)
