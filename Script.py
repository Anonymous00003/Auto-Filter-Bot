...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://telegram.me/Psycho440_bot'>ᴘꜱʏᴄʜᴏ</a>
</blockquote></b>"""
...
❏ 01 ᴡᴇᴇᴋ   – ₹19  (₹2.71/day)  
❏ 01 ᴍᴏɴᴛʜ  – ₹49  (₹1.63/day)  
❏ 03 ᴍᴏɴᴛʜs – ₹119 (₹1.32/day)
❏ 06 ᴍᴏɴᴛʜs – ₹199 (₹1.10/day)
❏ 12 ᴍᴏɴᴛʜs – ₹349 (₹0.96/day)
...
❏ ᴜɴʟɪᴍɪᴛᴇᴅ ᴍᴏᴠɪᴇꜱ, sᴇʀɪᴇs & ᴀɴɪᴍᴇ  
❏ ꜰᴜʟʟ ᴀᴅᴍɪɴ sᴜᴘᴘᴏʀᴛ  
❏ ʀᴇǫᴜᴇsᴛ ᴡɪʟʟ ʙᴇ ᴄᴏᴍᴘʟᴇᴛᴇᴅ ɪɴ 𝟷ʜ  

🚀 ᴜᴘɢʀᴀᴅᴇ ᴛᴏᴅᴀʏ ᴀɴᴅ ᴇɴᴊᴏʏ ᴜɴʟɪᴍɪᴛᴇᴅ ᴍᴏᴠɪᴇs, sᴇʀɪᴇs, ᴀɴᴅ ᴍᴏʀᴇ!

🆔 ᴜᴘɪ ɪᴅ - <code>soon@UPI</code>  
[ᴛᴀᴘ ᴛᴏ ᴄᴏᴘʏ]
...
"""
    ...
    DISCLAIMER_TEXT = """
ᴛʜɪs ɪs ᴀɴ ᴏᴘᴇɴ sᴏᴜʀᴄᴇ prᴏᴊᴇᴄᴛ.

ᴀʟʟ ᴛʜᴇ ꜰɪʟᴇs ɪɴ ᴛʜɪs bᴏᴛ ᴀʀᴇ ꜰʀᴇᴇʟʏ ᴀᴠᴀɪʟᴀʙʟᴇ ᴏɴ ᴛʜᴇ ɪɴᴛᴇʀɴᴇᴛ ᴏʀ pᴏsᴛᴇᴅ ʙʏ sᴏᴍᴇʙᴏᴅʏ ᴇʟsᴇ. ᴊᴜsᴛ ꜰᴏʀ ᴇᴀsʏ sᴇᴀʀᴄʜɪɴɢ ᴛʜɪs bᴏᴛ ɪs ɪɴᴅᴇxɪɴɢ ꜰɪʟᴇs wʜɪᴄʜ ᴀʀᴇ ᴀʟʏʀᴇᴀᴅʏ ᴜᴘʟᴏᴀᴅᴇᴅ ᴏɴ ᴛᴇʟᴇɢʀᴀᴍ. ᴡᴇ ʀᴇsᴘᴇᴄᴛ ᴀʟʟ ᴛʜᴇ cᴏᴘʏʀɪɢʜᴛ lᴀᴡs ᴀɴᴅ wᴏʀᴋs ɪɴ cᴏᴍᴘʟɪᴀɴᴄᴇ wɪᴛʜ dᴍᴄᴀ ᴀɴᴅ ᴇᴜᴄᴅ. ɪꜰ ᴀɴʏᴛʜɪɴɢ ɪs ᴀɢᴀɪɴsᴛ lᴀᴡ ᴘʟᴇᴀsᴇ cᴏɴᴛᴀᴄᴛ ᴍᴇ sᴏ ᴛʜᴀᴛ ɪᴛ cᴀɴ ʙᴇ ʀᴇᴍᴏᴠᴇᴅ ᴀsᴀᴘ. ɪᴛ ɪs ꜰᴏʀʙɪʙʟᴇɴ ᴛᴏ dᴏᴡɴʟᴏᴀᴅ, sᴛʀᴇᴀᴍ, ʀᴇᴘʀᴏᴅᴜcᴇ, sʜᴀʀᴇ ᴏʀ cᴏɴsᴜᴍᴇ cᴏɴᴛᴇɴᴛ wɪᴛʜᴏᴜᴛ ᴇxᴘʟɪcɪᴛ pᴇʀᴍɪssɪᴏɴ ꜰʀᴏᴍ ᴛʜᴇ cᴏɴᴛᴇɴᴛ cʀᴇᴀᴛᴏʀ ᴏʀ lᴇɢᴀʟ cᴏᴘʏʀɪɢʜᴛ hᴏʟᴅᴇʀ. ɪꜰ yᴏᴜ bᴇʟɪᴇvᴇ ᴛʜɪs bᴏᴛ ɪs vɪᴏʟᴀᴛɪɴɢ yᴏᴜʀ ɪɴᴛᴇʟʟᴇᴄᴛᴜᴀʟ prᴏpᴇʀᴛʏ, cᴏɴᴛᴀᴄᴛ ᴛʜᴇ rᴇsᴘᴇᴄᴛɪvᴇ cʜᴀɴɴᴇʟs ꜰᴏʀ rᴇᴍᴏᴠᴀʟ. ᴛʜᴇ bᴏᴛ dᴏᴇs ɴᴏᴛ ᴏᴡɴ ᴀɴʏ ᴏ꜀ ᴛʜᴇsᴇ cᴏɴᴛᴇɴᴛs, ɪᴛ ᴏɴʟʏ ɪɴᴅᴇxᴇs ᴛʜᴇ ꜰɪʟᴇs ꜰʀᴏᴍ ᴛʜᴇʟᴇɢʀᴀᴍ.
"""
   
    HELP_TXT = """<b>🤖 Basic Commands:</b>

🎭 ʜᴇʟᴘ ➾ <code>/help</code> 
🎭 ᴀʙᴏᴜᴛ ➾ <code>/about</code> 
🎭 sᴇᴀʀᴄʜ ➾ <code>/search movie name</code> 

🖼️ <b>Thumbnail Commands:</b>
🎭 sᴇᴛ ᴛʜᴜᴍʙ ➾ <code>/setthumb</code> 
🎭 ᴠɪᴇᴡ ᴛʜᴜᴍʙ ➾ <code>/viewthumb</code> 
🎭 ᴅᴇʟᴇᴛᴇ ᴛʜᴜᴍʙ ➾ <code>/delthumb</code> 

🔍 <b>Other Features:</b>
🎭 ᴛᴇʟᴇɢʀᴀᴘʜ ➾ <code>/telegraph</code> 
🎭 ғᴏɴᴛ sᴛʏʟᴇ ➾ <code>/font</code> 
🎭 ᴀɪ ᴛᴛs ➾ <code>/tts</code>"""
